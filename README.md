A single-cycle CPU using a subset of a RISC-based instruction set. Written in SystemVerilog on Quartus. Below is an image of the resulting waveforms obtained using ModelSim.
